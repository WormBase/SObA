...
//
// changed tazendra.caltech.edu/~azurebrd/cgi-bin/forms/datatype_objects.cgi to caltech-curation.textpressolab.com/pub/cgi-bin/forms/datatype_objects.cgi   2024 10 18
...
//             var sUrl = "https://tazendra.caltech.edu/~azurebrd/cgi-bin/forms/datatype_objects.cgi?action=autocompleteXHR&objectType=gene&";  	// to try to get from tazendra OA
            var sUrl = "https://caltech-curation.textpressolab.com/pub/cgi-bin/forms/datatype_objects.cgi?action=autocompleteXHR&objectType=gene&";  	// to try to get from tazendra OA
...
//     var url = 'soba.cgi?action=annotSummaryCytoscape&filterForLcaFlag=1&filterLongestFlag=1&showControlsFlag=0&datatype=' + datatypeValue + '&geneOneValue=' + geneOneValue + '&autocompleteValue=' + value;
...
//   let sUrl = 'http://wobr2.caltech.edu:8080/solr/' + datatypeValue + '/select?qt=standard&indent=on&wt=json&version=2.2&rows=100000&fl=regulates_closure,id,annotation_class&q=document_category:annotation&fq=-qualifier:%22not%22&fq=bioentity:%22' + geneId + '%22';		// CORS does not allow this nor localhost:8080
  let sUrl = 'soba.cgi?action=validateGeneDatatype&datatype=' + datatypeValue + '&gene=' + geneId; 
